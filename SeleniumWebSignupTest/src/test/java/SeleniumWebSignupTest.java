...
public class SeleniumWebSignupTest {
    ...
    public void SignUp() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("Dhre12");
        //6. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("Dhre@gmail.com");
        //7.Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("dhre1234");
    ...
    public void negativeSignup() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("Dh");
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("DO2@gmail.com");
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("DO24");
 ...
 @Test(priority = 6)
    public void negativeSignup1() throws InterruptedException {
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("Dre2");
        //Test8.Verify that user cannot Sign UP with invalid email address
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("dregmail.com");
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("dre1234");
        //5. Click on Signup button
        driver.findElement(By.id("submit")).click();
        Thread.sleep(5000);
        //6. Click on Login button
    ...
    public void negativeSignup3() throws InterruptedException {
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("drey1234");
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("drey1234@gmail.com");
        //Test10.Verify that user cannot login with password less than or equal to one character
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("h");
        //5. Click on Signup button
        driver.findElement(By.id("submit")).click();
        Thread.sleep(5000);
        //6. Click on Login button
