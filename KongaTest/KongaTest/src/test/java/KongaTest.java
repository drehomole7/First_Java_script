...
public class KongaTest {
    ...
    public void Login() throws InterruptedException {
        ...
        driver.findElement(By.id("username")).sendKeys("daredanielomole@gmail.com");

        //6. Locate the password field and input your password on the password field
        driver.findElement(By.id("password")).sendKeys("Realmadrid11.");
    ...
    public void CardDetails() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"card-number\"]")).sendKeys("2647-3789-6789-7896");
        // input card date on date field
        driver.findElement(By.xpath("//*[@id=\"expiry\"]")).sendKeys("9/9");
        // input cvv number in cvv field
        driver.findElement(By.xpath("//*[@id=\"cvv\"]")).sendKeys("678");
        Thread.sleep(5000);
    }
